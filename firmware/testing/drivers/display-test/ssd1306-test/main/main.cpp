...
#include "esp_log.h"
#include "ssd1306.h"
#include "driver/i2c_master.h"      // add near the other includes
...
extern "C" void app_main(void) {
   ...
   // was: SSD1306 display((gpio_num_t)SSD1306_SDA, (gpio_num_t)SSD1306_SCL);
    i2c_master_bus_config_t busCfg = {};
    busCfg.i2c_port          = I2C_NUM_0;
    busCfg.sda_io_num        = (gpio_num_t)SSD1306_SDA;
    busCfg.scl_io_num        = (gpio_num_t)SSD1306_SCL;
    ...
    SSD1306 display(bus, SSD1306_ADDR_DEFAULT);
