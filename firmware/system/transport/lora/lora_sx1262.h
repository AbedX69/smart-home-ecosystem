...
private:
    ...
    void setDio3AsTcxoCtrl(uint8_t voltage, uint32_t timeout_us);  // power TCXO via DIO3
    void calibrate(uint8_t blocks);                                // full block calibration (0x7F = all)
